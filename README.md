...
|                       |                       |
|-----------------------|-----------------------|
| <div style="display: flex; justify-content: center; align-items: center; padding: 0; margin: 0;"><img src="assets/responsive1.jpg" alt="Imagen 3" style="width:100%; height:auto;"></div> | <div style="display: flex; justify-content: center; align-items: center; padding: 0; margin: -30px;"><img src="assets/responsive3.jpg" alt="Imagen 3" style="width:73%; height:auto;"></div> |
